...
from data_io.data_loader_ipa import (DatasetPNG, worker_init_fn)
...
def train():
    ...
    train_set = DatasetPNG(base_path=cfg.DATA.TRAIN.ROOT, split='train', apply_augmentation=cfg.DATA.TRAIN.TRANSFORMS)
    val_set = DatasetPNG(base_path=cfg.DATA.VAL.ROOT, split='val', apply_augmentation=cfg.DATA.VAL.TRANSFORMS)
